...
while True:
    ...
    if readable:
        ...
        if answer.strip() == '':
            ...
            клиент не зависсал, пришлось сделать вывод этого сообщения. Например когда вы вводите команду для перехода
            в другую дирректорию сервер не возращает ничего и программа получает соотвественно ничего. Поэтому я решил данную проблему так-]\n""")
        else:
